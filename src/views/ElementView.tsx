...
// import ElementMenu from '../components/ElementMenu.tsx'
// import { format } from 'date-fns'

// interface Props {
//   settings: Signal<any>
//   element: Signal<any>
//   pinElementView: Signal<boolean>
...
//   return (
//     <div ref={refBox} className="z-0 h-full overflow-y-auto">
//       <Header
//         element={element}
//         pinElementView={pinElementView}
...
//           <input
//             type="text"
//             defaultValue={element.value?.name || ''}
...
//         <div>
//           <textarea
//             defaultValue={element.value?.description || ''}
...
//       <button className="ghost btn btn-xs text-nowrap rounded-full">+ Tag</button>
//     </div>
//   )
// }
...
//   )
// }
// const Dates = ({ dates, setDates, settings }: any) => {
//   return (
//     <div className="stat">
...
//           </button>
//         </div>
//         <ElementMenu id={element.value.id} onDeleteElement={onDeleteTask} />
//       </div>
//     </header>
//   )
// }
